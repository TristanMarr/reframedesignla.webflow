...
Webflow.require('ix').init([
  {"slug":"test","name":"test","value":{"style":{"opacity":0.37,"height":"72px","x":"0px","y":"-100px"},"triggers":[{"type":"load","stepsA":[{"wait":2000,"transition":"transform 1000ms ease 0ms, width 700ms ease 0ms, height 600ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}}
]);
